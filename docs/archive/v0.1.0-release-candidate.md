# v0.1.0 candidate release notes (archived)

> Archived 2026-09-09 after the public v0.1.0 release. This is the
> pre-publication candidate draft, kept for history. Current notes are in
...
> The draft's original status line said: local candidate draft; public
> visibility, tag and Release creation remain separate decisions. Those
> decisions were since made and are historical for this candidate period.
